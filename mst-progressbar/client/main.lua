...
RegisterNetEvent('mst-progressbar:client:ToggleBusyness')
AddEventHandler('mst-progressbar:client:ToggleBusyness', function(bool)
    isDoingAction = bool
end)
            ...
            Citizen.CreateThread(function()
                ...
                while isDoingAction do
                    ...
                    if IsControlJustPressed(0, Keys["ESC"]) and Action.canCancel then
                        TriggerEvent("mst-progressbar:client:cancel")
                    end
...
RegisterNetEvent("mst-progressbar:client:progress")
AddEventHandler("mst-progressbar:client:progress", function(action, finish)
    Process(action, nil, nil, finish)
end)

RegisterNetEvent("mst-progressbar:client:ProgressWithStartEvent")
AddEventHandler("mst-progressbar:client:ProgressWithStartEvent", function(action, start, finish)
    Process(action, start, nil, finish)
end)

RegisterNetEvent("mst-progressbar:client:ProgressWithTickEvent")
AddEventHandler("mst-progressbar:client:ProgressWithTickEvent", function(action, tick, finish)
    Process(action, nil, tick, finish)
end)

RegisterNetEvent("mst-progressbar:client:ProgressWithStartAndTick")
AddEventHandler("mst-progressbar:client:ProgressWithStartAndTick", function(action, start, tick, finish)
    Process(action, start, tick, finish)
end)

RegisterNetEvent("mst-progressbar:client:cancel")
AddEventHandler("mst-progressbar:client:cancel", function()
    Cancel()
end)
